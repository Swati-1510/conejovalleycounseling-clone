...
const CTASection = () => {
  return (
    <section className="w-full mt-12 md:mt-6 pt-4 md:pt-1 flex flex-col lg:flex-row justify-between items-stretch" style={{ backgroundColor: "var(--bg-secondary)" }}>
      ...
      {/* Left Edge Image */}
      <div className="hidden lg:flex w-[14.1%] items-center justify-start mt-48 pr-[2vw] relative">
        <img 
          ...
          className="w-full h-[66vh] object-cover object-right rounded-r-lg"
        />
      </div>
      ...
      {/* Right Edge Image */}
      <div className="hidden lg:flex w-full lg:w-[34.2%] items-center justify-end relative">
        <img 
          ...
          className="w-full h-[80vh] object-cover object-left rounded-l-lg"
        />
      </div>
